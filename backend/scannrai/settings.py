...
CELERY_TASK_ACKS_LATE = env('CELERY_TASK_ACKS_LATE', '1') == '1'
CELERY_TASK_REJECT_ON_WORKER_LOST = env('CELERY_TASK_REJECT_ON_WORKER_LOST', '1') == '1'
CELERY_WORKER_PREFETCH_MULTIPLIER = int(env('CELERY_WORKER_PREFETCH_MULTIPLIER', '1'))
CELERY_BROKER_VISIBILITY_TIMEOUT = int(
    env('CELERY_BROKER_VISIBILITY_TIMEOUT', str(max(CELERY_TASK_TIME_LIMIT * 2, 3600)))
)
...
SCAN_STALE_RUNNING_TIMEOUT_SECONDS = int(
    env('SCAN_STALE_RUNNING_TIMEOUT_SECONDS', str(max(CELERY_TASK_TIME_LIMIT + 300, 2100)))
)
