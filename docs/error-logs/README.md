...
This folder tracks build/runtime incidents with:
- symptom
- root cause
- fix
- verification steps
...
## Entries
- [2026-02-25 postgres startup failure (No space left on device)](./2026-02-25-postgres-no-space-left-on-device.md)
- [2026-02-25 frontend build failed (Radix module missing from stale node_modules volume)](./2026-02-25-frontend-radix-module-not-found-stale-node-modules.md)
